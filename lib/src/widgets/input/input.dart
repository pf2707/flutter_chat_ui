...
class InputOptions {
  ...
  /// Add a sticky widget above the input. This widget will move with input text field when start/end editing.
  final Widget? stickyWidgetAboveInput;
}
